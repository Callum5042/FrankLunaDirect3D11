...
// 
// Exercise 1:
//		Modify the lighting demo of this chapter so that the directional light
//		only emits red light, the point light only emits green light, and the 
//		spotlight only emits blue light. Using colored lights can be useful for 
//		different game moods; for example, a red light might be used to signify
...
{
	mMainWndCaption = L"Chapter 7 Lighting - Exercise 1";
