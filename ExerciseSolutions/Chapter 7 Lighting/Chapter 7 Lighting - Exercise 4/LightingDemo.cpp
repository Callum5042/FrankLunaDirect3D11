...
//		Press KeyUp to increase spotlight's cone
//		Press KeyDown to decrease spotlight's cone
// 
// Exercise 4:
//		Modify the lighting demo of this chapter so that the angle of the spotlight's
//		cone can be increased or decreased based on user keyboard input.
//
//***************************************************************************************
...
{
	mMainWndCaption = L"Chapter 7 Lighting - Exercise 4";
...
{
	// Update spotlight's cone (would be better to listen to the Win32 message queue but we don't want to touch the base d3dApp.cpp file)
