...
// 
// Exercise 3:
//		One characteristic of toon lighting is the abrupt transition from one color shade
//		to the next (in contrast with a smooth transition) as shown in Figure 7.23.
//		This can be implemented by computing kd and ks in the usual way, but then
//		transforming them by discrete functions like the following before using them
//		in the pixel shader:
// 
//					{ 0.4 if -∞  < kd ≤ 0.0
//		k'd = f(kd) { 0.6 if 0.0 < kd ≤ 0.5
//					{ 1.0 if 0.5 < kd ≤ 1.0
// 
//					{ 0.0 if 0.0 < ks ≤ 0.1
//		k's = g(ks) { 0.5 if 0.1 < ks ≤ 0.8
//					{ 0.8 if 0.8 < ks ≤ 1.0
// 
//		Modify the lighting demo of this chapter to use this sort of toon shading. (Note:
//		The functions f and g previously are just sample functions to start with, and can be
//		tweaked until you get the results you want.)
//
//***************************************************************************************
...
{
	mMainWndCaption = L"Chapter 7 Lighting - Exercise 3";
