...
// 
// Exercise 2:
//		Modify the solution to the previous exercise by using texture address modes so 
//		that points outside the projector's frustum do not receive light.
//
//***************************************************************************************
...
{
	mMainWndCaption = L"Chapter 21 Shadow Mapping - Exercise 2";
