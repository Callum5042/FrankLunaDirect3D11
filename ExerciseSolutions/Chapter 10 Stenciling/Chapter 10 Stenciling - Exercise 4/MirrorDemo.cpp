...
// 
// Exercise 4:
//		Modify the "Mirror" demo to produce the "Left" image in Figure 10.10.
// 
// Solution:
//		Disabled no double blending depth stencil state
//
//***************************************************************************************
...
{
	mMainWndCaption = L"Chapter 10 Stenciling - Exercise 4";
	mEnable4xMsaa = false;
