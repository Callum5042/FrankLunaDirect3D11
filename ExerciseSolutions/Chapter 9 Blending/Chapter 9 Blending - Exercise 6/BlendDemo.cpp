...
// 
// Exercise 6:
//		Modify the "Blend" demo by creating and applying a blend render state that
...
{
	mMainWndCaption = L"Chapter 9 Blending - Exercise 6";
	mEnable4xMsaa = false;
...
void BlendApp::UpdateScene(float dt)
{
	...
	/*if( GetAsyncKeyState('4') & 0x8000 )
		mRenderOptions = RenderOptions::DisabledRedGreen; */
}
