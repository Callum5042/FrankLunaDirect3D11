...
bool ParticlesApp::Init()
{
	...
	HR(DirectX::CreateDDSTextureFromFile(md3dDevice, L"Textures\\flare0.dds", &texResource, &mFlareTexSRV));
	...
	HR(DirectX::CreateDDSTextureFromFile(md3dDevice, L"Textures\\raindrop.dds", &texResource, &mRainTexSRV));
	ReleaseCOM(texResource); // view saves reference
